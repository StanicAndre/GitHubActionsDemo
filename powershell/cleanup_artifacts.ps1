...
$artifact_sorted = $artifacts | Sort-Object -Descending -Property id
$art_count = $artifact_sorted.Count;
$art_id_0 = $artifact_sorted[0].id;
$art_url_0 = $artifact_sorted[0].url;
